...
import { UsersExtendedService } from 'src/app/extended/entities/users/users.service';
...
export class UsertaskDetailsExtendedComponent extends UsertaskDetailsComponent implements OnInit {
	...
	constructor(
		...
		super(formBuilder, router, route, dialog, global, usertaskExtendedService, pickerDialogService, errorService,
		taskExtendedService,
