...
import com.fastcode.timesheettestapp.domain.core.authorization.userpermission.IUserpermissionRepository;
...
import com.fastcode.timesheettestapp.domain.core.authorization.user.IUserRepository;
...
public class UserpermissionControllerTest {
	...
	public static void cleanup() {
		...
		em.createNativeQuery("truncate table timesheet.userpermission RESTART IDENTITY").executeUpdate();

		em.createNativeQuery("truncate table timesheet.permission RESTART IDENTITY").executeUpdate();

		em.createNativeQuery("truncate table timesheet.f_user").executeUpdate();
