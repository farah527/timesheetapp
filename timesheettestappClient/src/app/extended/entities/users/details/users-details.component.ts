...
import { UsersDetailsComponent } from 'src/app/entities/users/index';
...
export class UsersDetailsExtendedComponent extends UsersDetailsComponent implements OnInit {
	...
	constructor(
		...
		super(formBuilder, router, route, dialog, global, usersExtendedService, pickerDialogService, errorService,
