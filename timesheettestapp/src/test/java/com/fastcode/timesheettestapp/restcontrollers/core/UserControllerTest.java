...
import com.fastcode.timesheettestapp.domain.core.authorization.userpreference.IUserpreferenceManager;
...
public class UserControllerTest {
	...
	public static void cleanup() {
		...
		em.createNativeQuery("truncate table timesheet.f_user RESTART IDENTITY").executeUpdate();

		em.createNativeQuery("truncate table timesheet.userpreference RESTART IDENTITY").executeUpdate();
